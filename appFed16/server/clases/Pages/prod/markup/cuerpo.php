			...
			<div class="card-item-white">
				<div class="row">
					<div class="col-md-6 hidden-xs">
						<button type="button" <?=$agotado?> class="jqCst btn btn-default btn-comprar btnAddCart" data-id="<?=$objOferta->GETid()?>"  data-ttl="<?=$objOferta->GETnombre()?>" data-unit="1" data-prc="<?=$objOferta->pvp()?>" data-src="<?=$objOferta->imgSrc()?>"><i class="glyphicon glyphicon-shopping-cart"></i>&nbsp;Añadir al carrito</button>
					</div>
					<div class="col-md-6 hidden-xs">
