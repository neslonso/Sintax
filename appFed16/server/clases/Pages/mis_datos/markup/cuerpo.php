				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							...
							<input class="form-control" type="text" name="emailAcceso" id="emailAcceso" disabled="disabled" value="<?=$cliente->email?>" />
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input class="form-control" type="text" name="movil" id="movil" value="<?=$cliente->movil?>" />
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<input name="publicidad" id="publicidad.Dummy" type="hidden" value="0" />
							<input name="publicidad" id="publicidad" type="checkbox" data-initialize="checkbox" value="1" <?=($cliente->publicidad==1)?"checked='checked'":"";?>/>
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input class="form-control"type="text" name="nif" id="nif" value="<?=$cliente->nif?>" />
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label for="razonSocial" accesskey="">Empresa:</label>
							<input class="form-control" type="text" name="razonSocial" id="razonSocial" value="<?=$cliente->razonSocial?>" />
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<input name="factura" id="factura.Dummy" type="hidden" value="0" />
							<input name="factura" id="factura" type="checkbox" value="1" <?=($cliente->factura==1)?"checked='checked'":"";?>/>
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input name="avisosSms" id="avisosSms" type="checkbox" value="1" <?=($cliente->avisosSms==1)?"checked='checked'":"";?>/>
			...
			<div id="panelDir<?=$direccion->id?>" class="panel panel-warning">
				...
				<div id="panelDirBody<?=$direccion->id?>" class="panel-body collapse">
					<form action="<?=BASE_DIR.FILE_APP?>" method="post" enctype="multipart/form-data" id="frmCliDir<?=$direccion->id?>">
						...
						<input name="idMulti_cliente" id="idMulti_cliente" type="hidden" value="<?=$cliente->id?>"/>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
				...
				<form action="<?=BASE_DIR.FILE_APP?>" method="post" enctype="multipart/form-data" id="frmCliDir0">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								<label for="destinatario" accesskey="">Destinatario:</label>
								<input class="form-control" type="text" name="destinatario" id="destinatario" value="<?=$cliente->nombre?> <?=$cliente->apellidos?>"  placeholder="Destinatario del envio" />
							</div>
						</div>
					</div>
					<div class="row">
...
?>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label for="movil" accesskey="">Teléfono de contacto:</label>
								<input class="form-control" type="text" name="movil" id="movil" value="<?=$cliente->movil?>" placeholder"Teléfono de contacto"/>
							</div>
						</div>
					</div>
				</form>
