<?
class Multi_pedidoLineaCredito extends Sintax\Core\Entity implements Sintax\Core\IEntity {
	protected static $table="multi_pedidoLineaCredito";
...
/* Getters y Setters **********************************************************/
	...
	public function GETtipo ($entity_decode=false) {return ($entity_decode)?html_entity_decode($this->arrDbData["tipo"],ENT_QUOTES,"UTF-8"):$this->arrDbData["tipo"];}
	public function SETtipo ($tipo,$entity_encode=false) {$this->arrDbData["tipo"]=($entity_encode)?htmlentities($tipo,ENT_QUOTES,"UTF-8"):$tipo;}
